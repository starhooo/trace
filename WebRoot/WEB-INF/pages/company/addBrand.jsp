...
<body>
	...
	<table  width="100%" border="0" cellspacing="5" cellpadding="0">
		<thead>
			<tr><td style="center;">当前位置：添加品牌</td></tr>
		</thead>
		<form  action="${pageContext.request.contextPath}/addbrand"   method="post">
		<tbody>
			<tr>
				<td style="text-align:right;">品牌名称</td>
				<td style="text-align:left;"><input id="brandname"  type="text" name="brandname" value=""/></td>
			</tr>
			<br/>
			<tr>
				<td style="text-align:right;" >品牌描述</td>
				<td style="text-align:left;"><textarea id="branddes" name="branddes" rows="8" cols="30"></textarea></td>

			</tr>
			<br/>
			<tr>
				<td style="text-align:right;" >上传商标 </td>
